...
- Early worktree access during creation (can open AI/editor while hooks are running)
- Step-based flow for create worktree dialog with improved UX

### Changed

- Consolidated streaming functions with comprehensive tests
